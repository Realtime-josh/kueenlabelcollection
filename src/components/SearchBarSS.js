    ...
    return(
      <div className='search-small-screen'>
        <table className='search-table-ss' align='right'>
          <tbody>
            <tr>
              <td className='search-image-td'><i className="search-icon-image-ss fa fa-search"></i></td>
              <td className='search-image-td'><i className="search-icon-image-ss fa fa-user-o"></i></td>
            </tr>
          </tbody>
        </table>
      </div>
